...
public final class resumoVenda_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(Categoria Citem: Clista){ 
    ...
    vendaDAO.incluir(venda);
      ...
      out.write("  \n");
      out.write("    \n");
      out.write("    <h2 class=\"venda\">Verifique se seu dados estão corretos e finalize a compra</h2>\n");
      out.write("\n");
...
for (ItemCarrinho itemCar : carrinho.getListaCarrinho()) {
      ...
      out.write("        <tr>              \n");
      out.write("            <th>");
      out.print(itemCar.getProduto().getTitulo());
      out.write("</th>\n");
      out.write("            <th>");
      out.print(itemCar.getProduto().getPreco() );
      out.write("</th>\n");
      out.write("                ");
}
      out.write("\n");
      ...
      out.write("            <a href=\"venda.jsp\" class=\"add-cart item_add\">Finalizar Compra</a>\t\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("\n");
