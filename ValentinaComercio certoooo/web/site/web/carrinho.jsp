...
<%    
    ...
    if(request.getMethod().equals("POST")){
        if(request.getParameter("excluirProduto") != null){ //colocar o excluir
            Produto obj = pDAO.buscarPorChavePrimaria(Integer.parseInt(request.getParameter("excluirProduto")));
                    ...
                    %>  
                        ...
                        <div class="btn_form">
                            ...
                            <%} else if(session.getAttribute("cliente") != null){%>
                                <a href="resumoVenda.jsp" class="add-cart item_add">Finalizar Compra</a>
                            <%}%>
                        </div>
                                </div>
             <script>$(document).ready(function(c) {
